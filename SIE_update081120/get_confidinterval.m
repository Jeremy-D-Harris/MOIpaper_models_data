function CI_estimate = get_confidinterval(data_super, paramsfit_co, model_num, log_susc_reduction, params_fixed)
...
F_plus_h = tranpose([(est_superinfection_H3_positive_percent_plus_h - superinfection_H3_positive_percent).^2, (est_superinfection_H1_positive_percent_plus_h - superinfection_H1_positive_percent).^2, (est_superinfection_H3_positive_H1_positive_percent_plus_h - superinfection_H3_positive_H1_positive_percent).^2]);
