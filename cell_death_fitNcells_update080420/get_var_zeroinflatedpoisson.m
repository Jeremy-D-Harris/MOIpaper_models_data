function sample_param_var_estimate = get_var_zeroinflatedpoisson(log_alpha, moi_vector_3hpi, moi_vector, moi_vector_FACs_data, all_hpi, data_allhpi, FACs_data_18hpi, model_num, cell_line)
