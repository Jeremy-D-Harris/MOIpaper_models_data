function sample_par_var_estimate = getvar_IFN_inputindependent_plusX_nb(log_lambda,moi_vector,log2_IFNdata,params_inputindependent,params_linear,params_saturating,alpha,hpi,model_ind,k_dispersion)
...
for k = 1:length(moi_vector)
    ...
    for n = 1:length(hpi)
        ...
        if n==1
            % input-independent (0-8 hpi) + input-independent (8-18 hpi)
            
            if isnan(this_8hpi_data)~=1
                
                
                params_inputindependent.r = lambda(1);
                IFNmodel_lambda_foldchange_inputindependent_8hpi = get_IFN_inputindependent_nb(this_moi, params_inputindependent,alpha,hpi(1),k_dispersion);
                log2_lambda_IFNmodel_8hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi);
                
                lambda_plus_h(1) = lambda(1) + h_small;
                params_inputindependent.r = lambda_plus_h(1);
                IFNmodel_lambda_plus_h_foldchange_inputindependent_8hpi = get_IFN_inputindependent_nb(this_moi, params_inputindependent,alpha,hpi(1),k_dispersion);
                log2_lambda_plus_h_IFNmodel_8hpi = log2(IFNmodel_lambda_plus_h_foldchange_inputindependent_8hpi);
            ...
            if isnan(this_18hpi_data)~=1
                ...
                if model_ind == 1
                    ...
                    log2_lambda_IFNmodel_inputindependentplusX_18hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi+IFNmodel_lambda_foldchange_inputindependent_8to18hpi);
                    ...
                    log2_lambda_plus_h_IFNmodel_inputindependentplusX_18hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi+IFNmodel_lambda_plus_h_foldchange_inputindependent_8to18hpi);
                    
                    Jf_logtheta(counter,2) = (lambda(2)/h_small)*(log2_lambda_plus_h_IFNmodel_inputindependentplusX_18hpi - log2_lambda_IFNmodel_inputindependentplusX_18hpi);
                    Jf_logtheta(counter,1) = 0;
                    
                    var_estimate(counter_var,1) = (this_18hpi_data - log2_lambda_IFNmodel_inputindependentplusX_18hpi)^2;
                    
                    counter = counter + 1;
                    counter_var = counter_var + 1;
                    
                elseif model_ind == 2
                    % input-independent (0-8 hpi) + linear (8-18 hpi)
                    ...
                    log2_lambda_IFNmodel_inputindependentplusX_18hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi+IFNmodel_lambda_foldchange_linear_8to18hpi);
                    ...
                    log2_lambda_plus_h_IFNmodel_inputindependentplusX_18hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi+IFNmodel_lambda_plus_h_foldchange_linear_8to18hpi);
                    ...
                    % input-independent (0-8 hpi) + saturating (8-18 hpi)
                    ...
                    log2_lambda_IFNmodel_inputindependentplusX_18hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi+IFNmodel_lambda_foldchange_saturating_8to18hpi);
                    ...
                    for m = 2:num_pars
                        ...
                        log2_lambda_plus_h_IFNmodel_inputindependentplusX_18hpi = log2(IFNmodel_lambda_foldchange_inputindependent_8hpi+IFNmodel_lambda_plus_h_foldchange_saturating_8to18hpi);
                        
                        Jf_logtheta(counter,m) = (lambda(m)/h_small)*(log2_lambda_plus_h_IFNmodel_inputindependentplusX_18hpi - log2_lambda_IFNmodel_inputindependentplusX_18hpi);
