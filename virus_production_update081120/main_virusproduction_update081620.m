% function void = main_estimate_virusproduction_update081620(void)
...
cell_line = 2; % 1: MDCK cells; 2: A549 cells
...
if cell_line == 1 % MDCK cells
    ...
    % r (dispersion) = 0.5974, CI[0.5078, 0.7029] 
...
%     save('results_MDCK_timedependentvirusproduction','results_timedependent');
    save('results_MDCK_timeindependentvirusproduction','results_timeindependent');
    
    else
        
%     save('results_A549_timedependentvirusproduction','results_timedependent');
    save('results_A549_timeindependentvirusproduction','results_timeindependent');
